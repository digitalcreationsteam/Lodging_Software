...
<table id="total-tab" width="100%">
	...
	{if isset($footer.room_price_tax_excl) && $footer.room_price_tax_excl}
		<tr>
			<td class="grey" width="30%">
				{l s='Total Rooms Cost (tax excl.)' pdf='true'}
			</td>
			<td class="white" width="70%" class="right">
	...
	{if isset($footer.amount_in_words) && $footer.amount_in_words}
	<tr class="bold">
		<td class="grey" width="30%">
			{l s='Amount in Words' pdf='true'}
		</td>
		<td class="white" width="70%" class="right">
			{$footer.amount_in_words}
		</td>
	</tr>
	{/if}
